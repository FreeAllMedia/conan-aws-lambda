...
import updateLambdaAlias from "../../lib/steps/updateLambdaAlias.js";
import sinon from "sinon";

describe(".updateLambdaAlias(conan, context, stepDone)", () => {
	let conan,
			context,
			stepDone,
	...
	describe("(When calling AWS)", () => {
		beforeEach(done => {
			...
			updateLambdaAlias(conan, context, stepDone(done));
		});

		it("should be a function", () => {
			(typeof updateLambdaAlias).should.equal("function");
		});
