...
var _validateLambda = require("../../lib/steps/validateLambda.js");

var _validateLambda2 = _interopRequireDefault(_validateLambda);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

describe(".validateLambda(conan, context, stepDone)", function () {
	var conan = undefined,
	    context = undefined;
	...
	describe("(When lambda is valid)", function () {
		beforeEach(function (done) {
			...
			(0, _validateLambda2.default)(conan, context, stepDone(done));
		});
