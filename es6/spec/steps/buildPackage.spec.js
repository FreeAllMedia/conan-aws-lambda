import buildPackage from "../../lib/steps/buildPackage.js";
...
describe(".buildPackage(conan, context, stepDone)", () => {
	let mockConan,
			context,
	...
	beforeEach(() => {
		...
		temporaryDirectoryPath = temp.mkdirSync("buildPackage");
	...
	describe("(when .packages() are set)", () => {
		beforeEach(done => {
			...
			buildPackage(mockConan, context, stepDone(done));
		});
