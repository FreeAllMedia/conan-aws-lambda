...
import findLambdaAlias from "../../lib/steps/findLambdaAlias.js";
import sinon from "sinon";
import chai from "chai";

describe(".findLambdaAlias(conan, context, stepDone)", () => {
	let conan,
		should,
		context,
		stepDone,
	...
	describe("(When calling AWS)", () => {
		beforeEach(done => {
			...
			findLambdaAlias(conan, context, stepDone(done));
		});
		...
		describe("(Not Found is Returned)", () => {
			...
			it("should skip the alias because it does not exist", done => {
				findLambdaAlias(conan, context, (error) => {
