...
import createLambdaAlias from "../../lib/steps/createLambdaAlias.js";
import sinon from "sinon";

describe(".createLambdaAlias(conan, context, stepDone)", () => {
	let conan,
			context,
			stepDone,
	...
	describe("(When calling AWS)", () => {
		beforeEach(done => {
			...
			createLambdaAlias(conan, context, stepDone(done));
		});

		it("should be a function", () => {
			(typeof createLambdaAlias).should.equal("function");
		});
