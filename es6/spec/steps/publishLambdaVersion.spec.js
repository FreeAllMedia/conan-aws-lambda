...
import publishLambdaVersion from "../../lib/steps/publishLambdaVersion.js";
import sinon from "sinon";

describe(".publishLambdaVersion(conan, context, stepDone)", () => {
	let conan,
			context,
			stepDone,
	...
	describe("(When calling AWS)", () => {
		beforeEach(done => {
			...
			publishLambdaVersion(conan, context, stepDone(done));
		});

		it("should be a function", () => {
			(typeof publishLambdaVersion).should.equal("function");
		});
