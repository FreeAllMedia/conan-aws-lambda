...
describe(".upsertLambda(conan, context, stepDone)", () => {
	let conan,
			context,
			stepDone,
	...
	beforeEach(done => {
		...
		upsertLambda(conan, context, stepDone(done));
	});
	...
	it("should be a function", () => {
		(typeof upsertLambda).should.equal("function");
	});
	...
	describe("(When Lambda is NOT New)", () => {
		...
		describe("(Lambda Code is NOT Updated)", () => {
			...
			it("should return an error", () => {
				upsertLambda(conan, context, (error) => {
